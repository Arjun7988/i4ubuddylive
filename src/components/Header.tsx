...
const mainMenuItems = [
  ...
  { to: '/rsvp', icon: Calendar, label: 'RSVP', requiresAuth: false },
  { to: '/coupons', icon: Ticket, label: 'Coupons', requiresAuth: false },
  { to: '/split', icon: Split, label: 'Split Wise', requiresAuth: false },
  { to: '/travel', icon: Plane, label: 'Travel Companion', requiresAuth: false },
  { to: '/chatbot', icon: MessageCircle, label: 'ChatBot', requiresAuth: false },
];
          ...
          <div className="flex items-center space-x-3">
            ...
            {!user ? (
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  onClick={signOut}
                  className="px-3 py-1.5 text-sm font-medium text-gray-300 hover:text-red-400 transition-colors flex items-center space-x-1"
                >
            ...
            {user && (
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 rounded-lg font-medium text-sm transition-all text-gray-400 hover:text-white hover:bg-gradient-button/10"
                >
