...
const services: Service[] = [
  {
    ...
    titlePart1: 'Buy & Sell',
    titlePart2: 'Smarter',
    description: 'Your complete marketplace for buying, selling, and discovering amazing deals in your trusted community.',
  ...
  },
  {
    ...
    titlePart1: 'Explore World',
    titlePart2: 'Together',
    description: 'Connect with fellow adventurers, share journeys, and create unforgettable travel memories worldwide.',
  ...
  },
  {
    icon: Bot,
    title: 'AI Chatbot',
    titlePart1: 'Get Answers',
    titlePart2: 'Instantly',
    description: 'AI-powered financial insights, smart advice, and instant support for all your money questions.',
  ...
  },
  {
    icon: Calendar,
    title: 'RSVP Events',
    titlePart1: 'Plan Events',
    titlePart2: 'Effortlessly',
    description: 'Create memorable gatherings, track RSVPs, and manage your guest list with seamless coordination.',
  ...
  },
  {
    ...
    titlePart2: 'Daily',
    description: 'Discover exclusive deals, unlock special offers, and maximize savings with curated coupons near you.',
