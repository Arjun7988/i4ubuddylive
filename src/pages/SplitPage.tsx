...
import { Plus, Users, ArrowUpRight, ArrowDownLeft, Receipt, Edit2, Trash2, X, User as UserIcon, Copy, Check, Share2, Split as SplitIcon } from 'lucide-react';
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 p-3 bg-primary-500/10 rounded-lg border border-primary-500/50 text-primary-400 hover:bg-primary-500/20 transition-all"
              >
