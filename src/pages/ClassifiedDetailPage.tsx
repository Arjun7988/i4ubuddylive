...
import { MapPin, Tag, Eye, Mail, Phone, Edit, Trash2, Check, Archive, Share2, X, ChevronLeft } from 'lucide-react';
...
export function ClassifiedDetailPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="relative flex-1 pt-[calc(128px+50px)] max-w-6xl mx-auto px-4 py-8 w-full">
        <div className="mb-6">
          <Link
            to="/classifieds"
        ...
        <AdSenseAd slotId={ADSENSE_SLOTS.DETAIL_TOP} className="mb-6" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <GlowingCard>
              <div className="space-y-6">
                <div>
                  ...
                  <AdSenseAd slotId={ADSENSE_SLOTS.DETAIL_IN_ARTICLE} className="my-6" />
          ...
          <div className="space-y-6">
            ...
            <GlowingCard>
              <h3 className="font-semibold text-white mb-4">Share Listing</h3>
              <button
                onClick={handleShare}
            ...
            {classified.status === 'active' && !isOwner && (
              <GlowingCard>
                <h3 className="font-semibold text-white mb-4">Contact Seller</h3>
                <div className="space-y-3">
                  {classified.created_by?.full_name && (
                    <div>
                      <div className="text-sm text-gray-400 mb-1">Seller</div>
                      <div className="text-white">{classified.created_by.full_name}</div>
                    </div>
                  )}
            ...
            <AdSenseAd slotId={ADSENSE_SLOTS.DETAIL_BOTTOM} />
          </div>
        </div>

        <div className="my-12">
          <AdSenseAd slotId={ADSENSE_SLOTS.LIST_TOP} />
        </div>
