...
import { Shield, LogOut, ArrowLeft, User, Trash2, Pin, Send } from 'lucide-react';
...
export function AdminChatManagementPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-background via-background to-surface flex flex-col overflow-hidden">
      <div className="border-b border-border/50 bg-background/80 backdrop-blur-xl flex-shrink-0 z-50">
      ...
      <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex flex-col overflow-hidden min-h-0">
